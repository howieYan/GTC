...
export default class MessageCenter extends React.Component {
    ...
    async loadData() {
        try{
            ...
            this.props.navigation.setParams({title: this.state.language.app_nav_name_Message})
                ...
                list.push(
                    <TouchableOpacity key={i} activeOpacity={0.8} onPress={this.onMessageDetails.bind(this, v.msg_id)}>
                        <View style={styles.messageList}>
                            ...
                            <Text style={styles.messageListTextTime}>{Utils.formatTs(v.msg_addtime, 'YYYY年MM月DD')}</Text>
                        </View>
                    </TouchableOpacity>
                )
            })
